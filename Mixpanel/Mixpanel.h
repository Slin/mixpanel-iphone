...
#define MIXPANEL_NO_REACHABILITY_SUPPORT 1//(defined(MIXPANEL_TVOS) || defined(MIXPANEL_WATCHOS) || defined(MIXPANEL_MACOS))
#define MIXPANEL_NO_AUTOMATIC_EVENTS_SUPPORT 1//(defined(MIXPANEL_TVOS) || defined(MIXPANEL_WATCHOS) || defined(MIXPANEL_MACOS))
#define MIXPANEL_NO_NOTIFICATION_AB_TEST_SUPPORT 1//(defined(MIXPANEL_TVOS) || defined(MIXPANEL_WATCHOS) || defined(MIXPANEL_MACOS))
#define MIXPANEL_NO_CONNECT_INTEGRATION_SUPPORT 1//(defined(MIXPANEL_TVOS) || defined(MIXPANEL_WATCHOS) || defined(MIXPANEL_MACOS))
#define MIXPANEL_NO_APP_LIFECYCLE_SUPPORT 1//defined(MIXPANEL_WATCHOS)
#define MIXPANEL_NO_UIAPPLICATION_ACCESS 0//(defined(MIXPANEL_WATCHOS) || defined(MIXPANEL_MACOS))
